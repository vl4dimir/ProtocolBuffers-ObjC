...
ExtensionGenerator::ExtensionGenerator(string classname,
...
void ExtensionGenerator::GenerateMembersHeader(io::Printer* printer) {
	...
	printer->Print(vars, "+ (id<PBExtensionField>) $name$;\n");
}
...
void ExtensionGenerator::GenerateInitializationSource(io::Printer* printer) {
	...
	vars["is_wire_format"] =
			descriptor_->containing_type()->options().message_set_wire_format() ?
					"YES" : "NO";
	...
	printer->Print(vars, "$containing_type$_$name$ =\n");
...
void ExtensionGenerator::GenerateRegistrationSource(io::Printer* printer) {
	printer->Print("[registry addExtension:$scope$_$name$];\n", "scope",
			classname_, "name", UnderscoresToCamelCase(descriptor_));
}
} // namespace objectivec
} // namespace compiler
} // namespace protobuf
